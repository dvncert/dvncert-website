...
const slaytlar = [
  ...
  },
  {
    ...
    buton1: { yazi: "Belge sorgula", link: "/sertifika-sorgula", renk: "altin" },
    ...
    <svg width="100%" height="100%" viewBox="0 0 360 320" fill="none" style={{ maxWidth: 380 }}>
      ...
      <defs>
        <radialGradient id="glow1">
          <stop offset="0%" stopColor="#D4A93F" stopOpacity="0.4" />
          <stop offset="100%" stopColor="#D4A93F" stopOpacity="0" />
        </radialGradient>
      ...
      <g transform="translate(60, 50) rotate(-6 130 90)">
        <rect width="240" height="160" rx="12" fill="rgba(212,169,63,0.08)" stroke="rgba(212,169,63,0.25)" strokeWidth="1" />
      </g>
      ...
      <g transform="translate(70, 70)">
        ...
        {/* Başlık şeridi */}
        <rect x="20" y="20" width="80" height="6" rx="3" fill="#F58220" />
        <text x="20" y="50" fill="#ffffff" fontFamily="Calibri" fontSize="13" fontWeight="500">CERTIFICATE</text>
        <text x="20" y="68" fill="#E8C870" fontFamily="Calibri" fontSize="10" letterSpacing="1">ISO 9001 : 2015</text>
        ...
        <g transform="translate(170, 120)">
          <circle cx="0" cy="0" r="28" stroke="#F58220" strokeWidth="2" fill="rgba(245,130,32,0.12)" />
          <circle cx="0" cy="0" r="22" stroke="#F58220" strokeWidth="1" fill="none" />
          <path d="M-8 0 L-2 6 L8 -6" stroke="#FFA050" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none" />
          <text x="0" y="-32" textAnchor="middle" fill="#FFA050" fontFamily="Calibri" fontSize="7" fontWeight="500" letterSpacing="0.5">TÜRKAK</text>
        </g>
      ...
      <g transform="translate(280, 30)">
        <path d="M0 0 L20 -8 L40 0 L40 20 Q40 35 20 42 Q0 35 0 20 Z" fill="rgba(212,169,63,0.2)" stroke="#E8C870" strokeWidth="1.5" />
        <path d="M12 18 L18 24 L28 12" stroke="#E8C870" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    </svg>
  );
}
...
function SorgulamaMockup() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 360 320" fill="none" style={{ maxWidth: 380 }}>
      ...
      {/* İçerik */}
      <text x="76" y="100" fill="#E8C870" fontFamily="Calibri" fontSize="9" letterSpacing="1">BELGE SORGULAMA</text>
      ...
      {/* Sonuç - başarılı */}
      <rect x="76" y="170" width="212" height="38" rx="6" fill="rgba(212,169,63,0.18)" stroke="rgba(212,169,63,0.4)" strokeWidth="1" />
      <circle cx="92" cy="189" r="9" fill="#D4A93F" />
...
function DenetimMockup() {
  return (
    <svg width="100%" height="100%" viewBox="0 0 360 320" fill="none" style={{ maxWidth: 380 }}>
      ...
      <g opacity="0.25">
        <rect x="40" y="180" width="40" height="80" fill="#E8C870" />
        <rect x="80" y="160" width="50" height="100" fill="#E8C870" />
        <rect x="130" y="190" width="35" height="70" fill="#E8C870" />
        <polygon points="80,160 105,140 130,160" fill="#E8C870" />
        <rect x="50" y="130" width="6" height="55" fill="#E8C870" />
        <rect x="92" y="115" width="6" height="50" fill="#E8C870" />
      </g>
      ...
      <g transform="translate(140, 50)">
        ...
        <g transform="translate(20, 148)">
          <circle cx="6" cy="6" r="6" fill="rgba(255,255,255,0.15)" stroke="#F58220" strokeWidth="1.5" />
        ...
        {/* Buton */}
        <rect x="20" y="184" width="140" height="14" rx="3" fill="#F58220" opacity="0.9" />
        <text x="90" y="194" textAnchor="middle" fill="white" fontFamily="Calibri" fontSize="8" fontWeight="500">Raporu Tamamla</text>
      </g>

      {/* Sol üstte rozet */}
      <g transform="translate(40, 50)">
        <circle cx="20" cy="20" r="18" fill="rgba(245,130,32,0.18)" stroke="#F58220" strokeWidth="1.5" />
        <text x="20" y="17" textAnchor="middle" fill="#FFA050" fontFamily="Calibri" fontSize="7" fontWeight="500">2.TARAF</text>
        <text x="20" y="27" textAnchor="middle" fill="#FFA050" fontFamily="Calibri" fontSize="7" fontWeight="500">DENETİM</text>
      </g>
    </svg>
  );
}
...
export default function HeroSlider() {
  ...
  return (
    <>
      ...
      >
        <div style={{ position: "absolute", top: -60, right: -60, width: 320, height: 320, border: "1px solid rgba(212,169,63,0.12)", borderRadius: "50%" }} />
        <div style={{ position: "absolute", top: 20, right: 50, width: 220, height: 220, border: "1px solid rgba(245,130,32,0.10)", borderRadius: "50%" }} />
            ...
            <div>
              <div
                style={{
                  ...
                  background: slayt.rozetRenk === "altin" ? "rgba(212,169,63,0.15)" : "rgba(245,130,32,0.15)",
                  color: slayt.rozetRenk === "altin" ? "var(--dvn-altin-acik)" : "var(--dvn-turuncu-acik)",
                  padding: "6px 16px",
                  borderRadius: 999,
                  fontSize: 12,
                  fontWeight: 500,
                  marginBottom: 16,
                  border: slayt.rozetRenk === "altin" ? "0.5px solid rgba(212,169,63,0.3)" : "0.5px solid rgba(245,130,32,0.3)",
                }}
              >
                {slayt.rozet}
              </div>
              <h1 style={{ color: "white", fontSize: 38, fontWeight: 500, lineHeight: 1.2, margin: "0 0 16px" }}>
                {slayt.baslik}{" "}
                <span style={{ color: slayt.rozetRenk === "altin" ? "var(--dvn-turuncu-acik)" : "var(--dvn-altin-acik)" }}>
                  {slayt.baslikVurgu}
                </span>{" "}
                {slayt.baslikSon}
              </h1>
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                <Link
                  ...
                  style={{
                    background: slayt.buton1.renk === "turuncu" ? "var(--dvn-gradient-turuncu)" : "var(--dvn-gradient-altin)",
                    color: "white",
                    padding: "13px 24px",
                    borderRadius: 8,
                    fontWeight: 500,
                    fontSize: 13,
                    boxShadow: slayt.buton1.renk === "turuncu" ? "0 8px 20px rgba(245,130,32,0.3)" : "0 8px 20px rgba(212,169,63,0.3)",
