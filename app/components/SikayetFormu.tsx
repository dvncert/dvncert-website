  ...
  return (
    <form onSubmit={gonder} className="dvn-sikayet-form" style={{ display: "grid", gap: 16, position: "relative" }}>
      ...
      <div className="dvn-form-satir" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
        ...
        <label style={alanStili}>
          <span style={etiketStili}>İlgili belge no / firma</span>
          <input name="ilgili" type="text" placeholder="Sertifika no veya kuruluş adı" style={inputStili} />
        </label>
      </div>

      <label style={alanStili}>
        <span style={etiketStili}>Açıklama *</span>
        <textarea name="mesaj" required rows={5} placeholder="Şikayet, itiraz, öneri veya görüşünüzü ayrıntılı yazınız..." style={{ ...inputStili, resize: "vertical", minHeight: 130 }} />
      </label>
      ...
      <style>{`
        ...
        @media (max-width: 560px) {
          .dvn-sikayet-form .dvn-form-satir { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </form>
  );
