...
export default function DuyurularSayfasi() {
  const [oneCikan, ...digerleri] = duyurular;
    ...
    <main>
      ...
      <section style={{ background: "white", padding: "60px 32px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          {/* Öne çıkan (en yeni) duyuru */}
          {oneCikan && (
            <Link
              href={`/duyurular/${oneCikan.slug}`}
            ...
            >
              <div style={{ padding: "40px 38px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
                  ...
                  <span style={{ fontSize: 12.5, color: "#9aa5b1" }}>{tarihiBicimle(oneCikan.tarih)}</span>
                </div>
                <h2 style={{ color: "white", fontSize: 24, fontWeight: 500, margin: "0 0 14px", lineHeight: 1.35 }}>
                  {oneCikan.baslik}
                </h2>
                <p style={{ fontSize: 14, color: "#cbd5e1", lineHeight: 1.7, margin: "0 0 22px" }}>{oneCikan.ozet}</p>
              ...
              {/* Görsel alanı - gorsel varsa gerçek resim, yoksa yer tutucu */}
              <div
                className="dvn-one-cikan-gorsel"
                style={{
                  position: "relative",
          ...
          {digerleri.length > 0 && (
            <div
              className="dvn-duyuru-liste-grid"
            ...
            >
              {digerleri.map((d) => (
                ...
                >
                  ...
                  <h3 style={{ color: "var(--dvn-lacivert)", fontSize: 16, fontWeight: 500, margin: "0 0 10px", lineHeight: 1.4 }}>
                    {d.baslik}
                  </h3>
