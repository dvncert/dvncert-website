...
const hizliBaglantilar = [
  ...
  { etiket: "İlkeler", hash: "ilkeler" },
  { etiket: "Faydalar", hash: "faydalar" },
  { etiket: "Nasıl Alınır?", hash: "nasil-alinir" },
  { etiket: "Geçerlilik", hash: "gecerlilik" },
];

const ilgiliStandartlar = [
  { href: "/hizmetler/iso-14001", kod: "ISO 14001", ad: "Çevre Yönetim Sistemi" },
  { href: "/hizmetler/iso-45001", kod: "ISO 45001", ad: "İş Sağlığı ve Güvenliği Yönetim Sistemi" },
  { href: "/hizmetler/iso-50001", kod: "ISO 50001", ad: "Enerji Yönetim Sistemi" },
];
...
export default function Iso9001Sayfasi() {
  ...
  return (
    <main>
      ...
      {/* Header + breadcrumb + hero (mevcut yapı korunuyor) */}
      <SayfaBaslik
      ...
      <section style={{ background: "white", padding: "48px 32px 10px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <p style={{ ...P, margin: 0 }}>
            ISO 9001 Kalite Yönetim Sistemi belgelendirmesi hakkında bilmek istediklerinizi aşağıdaki bölümlerden
            öğrenebilirsiniz. Standardın tanımından belgelendirme sürecine, geçerlilik koşullarından sertifika
            doğrulamaya kadar tüm konuları detaylı şekilde ele aldık.
          </p>
      ...
      <section style={{ background: "white", padding: "22px 32px 60px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          {/* AKORDEON 1 — Nedir? (açık başlar) */}
          <Akordeon baslik="ISO 9001 Belgesi Nedir?" id="nedir" defaultOpen>
            <p style={P}>
            ...
            <p style={P}>
              ...
              ölçekte kuruluşa uygulanabilir. Üretim, hizmet, sağlık, eğitim, inşaat, bilgi teknolojileri, tekstil,
              gıda, lojistik ve daha pek çok sektörden binlerce kuruluş ISO 9001 belgesine sahiptir. KOBİ ölçeğindeki
              bir aile işletmesinden çok uluslu bir holding şirketine kadar, faaliyet alanı veya çalışan sayısı fark
              etmeksizin standart şartlarını karşılayan her organizasyon ISO 9001 belgesi alabilir.
            </p>
            <p style={{ ...P, margin: 0 }}>
              Türkiye&apos;de ISO 9001 belgesinin uluslararası geçerliliğe sahip olabilmesi için TÜRKAK (Türk
          ...
          {/* AKORDEON 2 — Temel İlkeler */}
          <Akordeon baslik="ISO 9001 Kalite Yönetim Sisteminin Temel İlkeleri" id="ilkeler">
            <p style={P}>
          ...
          {/* AKORDEON 3 — Faydalar */}
          <Akordeon baslik="ISO 9001:2015 Belgesinin Faydaları" id="faydalar">
            <p style={P}>
            ...
            <p style={{ ...P, margin: "10px 0 0" }}>
              ISO 9001 belgesinin sağladığı faydaların düzeyi, kuruluşun standardı ne ölçüde benimsediği ve sistemi
              günlük operasyonlarına ne kadar entegre ettiği ile doğrudan ilişkilidir. Belgenin alınması başlangıç
              noktasıdır; asıl değer, sistemin yaşatılması ve sürekli iyileştirilmesi ile ortaya çıkar.
            </p>
          </Akordeon>

          {/* AKORDEON 4 — Nasıl Alınır? */}
          <Akordeon baslik="ISO 9001 Belgesi Nasıl Alınır? — Belgelendirme Süreci" id="nasil-alinir">
            <p style={P}>
            ...
            <p style={{ ...P, margin: "0 0 22px" }}>ISO 9001 belgelendirme süreci aşağıdaki ana adımlardan oluşur.</p>
          ...
          {/* AKORDEON 5 — Geçerlilik */}
          <Akordeon baslik="ISO 9001 Belgesinin Geçerlilik Süresi ve Yenileme" id="gecerlilik">
            <p style={P}>
              ISO 9001 belgesi süresiz bir sertifika değildir. Belgenin geçerliliği belirli bir süre ile sınırlıdır ve
              bu süre boyunca kuruluşun kalite yönetim sistemini standardın gerekliliklerine uygun şekilde sürdürmesi
              beklenir.
            </p>
      ...
      <section style={{ background: "var(--dvn-gradient-lacivert)", padding: "60px 32px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <p style={{ color: "#cbd5e1", fontSize: 14.5, lineHeight: 1.7, margin: "0 0 28px", maxWidth: 720 }}>
            ISO 9001 ile birlikte kuruluşunuza entegre edebileceğiniz diğer yönetim sistemi standartları:
          </p>
